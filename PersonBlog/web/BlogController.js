...
path.set('/editBlog',editBlog)
 ...
 function queryTag(tag,blogId){
    tagsDao.queryTag(tag,function(result){
        if(result == null || result.length == 0){
            ...
            tagBlogMappingDao.insertTagBolgMapping(result[0].id,blogId,timeUtil.getNow(),timeUtil.getNow(),function(result){})
        }
    })
 }
 ...
 function insertTagBlogMapping(tagId,blogId){
    tagBlogMappingDao.insertTagBolgMapping(tagId,blogId,timeUtil.getNow(),timeUtil.getNow(),function(result){
